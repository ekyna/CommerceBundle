 ...
 */
class CartTransformCommand extends ContainerAwareCommand
{
    /**
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->cartRepository = $container->get('ekyna_commerce.cart.repository');
        $this->orderRepository = $container->get('ekyna_commerce.order.repository');
        $this->saleTransformer = $container->get('ekyna_commerce.sale_transformer');
    }
