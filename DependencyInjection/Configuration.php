                    ...
                    ->children()
                        ...
                        ->arrayNode('bundle_choice')
                            ...
                            ->children()
                                ...
                                ->scalarNode('parent')->defaultValue('ekyna_commerce.bundle_slot')->end()
                            ->end()
                        ->end()
                        ->arrayNode('bundle_choice_rule')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Product\Entity\BundleChoiceRule')->end()
                                ->scalarNode('parent')->defaultValue('ekyna_commerce.bundle_choice')->end()
                            ->end()
                        ->end()
                        ->arrayNode('bundle_slot')
                            ...
                            ->children()
                                ...
                                ->scalarNode('parent')->defaultValue('ekyna_commerce.product')->end()
