                    ...
                    ->children()
                        ...
                        ->arrayNode('payment_method')
                            ...
                            ->children()
                                ...
                                ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\PaymentMethodType')->end()
                        ...
                        ->arrayNode('shipment_method')
                            ...
                            ->children()
                                ...
                                ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\ShipmentMethodType')->end()
