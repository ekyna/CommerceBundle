...
class Configuration implements ConfigurationInterface
{
    ...
    /**
     * Adds `cart resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addCartResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('cart')
                ->addDefaultsIfNotSet()
    ...
    /**
     * Adds `common resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addCommonResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('accounting')
                ->addDefaultsIfNotSet()
    ...
    /**
     * Adds `customer resources` section.
     *
     * @param NodeBuilder $node
     */
    ...
    /**
     * Adds `newsletter resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addNewsletterResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('audience')
                ->addDefaultsIfNotSet()
                ->children()
                    ->variableNode('templates')->defaultValue([
                        '_form.html'  => '@EkynaCommerce/Admin/Audience/_form.html',
                        'list.html'   => '@EkynaCommerce/Admin/Audience/list.html',
                        'show.html'   => '@EkynaCommerce/Admin/Audience/show.html',
                    ])->end()
                    ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Newsletter\Entity\Audience')->end()
                    ->scalarNode('controller')->defaultValue('Ekyna\Bundle\CommerceBundle\Controller\Admin\AudienceController')->end()
                    ->scalarNode('operator')->end()
                    ->scalarNode('repository')->defaultValue('Ekyna\Component\Commerce\Bridge\Doctrine\ORM\Repository\AudienceRepository')->end()
                    ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Newsletter\AudienceType')->end()
                    ->scalarNode('table')->defaultValue('Ekyna\Bundle\CommerceBundle\Table\Type\AudienceType')->end()
                    ->scalarNode('parent')->end()
                    ->scalarNode('event')->end()
                    ->arrayNode('translation')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Newsletter\Entity\AudienceTranslation')->end()
                            ->scalarNode('repository')->end()
                            ->arrayNode('fields')
                                ->prototype('scalar')->end()
            ...
            ->arrayNode('member')
                ...
                ->children()
                    ->variableNode('templates')->defaultValue([
                        '_form.html' => '@EkynaCommerce/Admin/Member/_form.html',
                        'show.html'  => '@EkynaCommerce/Admin/Member/show.html',
                    ])->end()
                    ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Newsletter\Entity\Member')->end()
                    ->scalarNode('controller')->end()
                    ->scalarNode('operator')->end()
                    ->scalarNode('repository')->defaultValue('Ekyna\Component\Commerce\Bridge\Doctrine\ORM\Repository\MemberRepository')->end()
                    ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Newsletter\MemberType')->end()
                    ->scalarNode('table')->defaultValue('Ekyna\Bundle\CommerceBundle\Table\Type\MemberType')->end()
                    ->scalarNode('parent')->end()
                    ->scalarNode('event')->end()
                ->end()
            ->end()
            ->arrayNode('subscription')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Newsletter\Entity\Subscription')->end()
                    ->scalarNode('repository')->defaultValue('Ekyna\Component\Commerce\Bridge\Doctrine\ORM\Repository\SubscriptionRepository')->end()
                    ->scalarNode('parent')->defaultValue('ekyna_commerce.member')->end()
                ->end()
            ->end();
    }
    ...
    /**
     * Adds `order resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addOrderResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('order')
                ->addDefaultsIfNotSet()
    ...
    /**
     * Adds `payment resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addPaymentResourcesSection(NodeBuilder $node)
    {
        $node
                ...
                ->children()
                    ...
                    ->arrayNode('translation')
                        ...
                        ->children()
                            ...
                            ->arrayNode('fields')
                                ->prototype('scalar')->end()
                                ->defaultValue(['title', 'description', 'notice', 'mention', 'footer'])
                            ->end()
                        ->end()
                    ->end()
                ->end()
            ->end()
            ->arrayNode('payment_method_mention')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Payment\Entity\PaymentMethodMention')->end()
                    ->scalarNode('repository')->end()
                    ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Payment\PaymentMethodMentionType')->end()
                    ->scalarNode('parent')->defaultValue('ekyna_commerce.payment_method')->end()
                    ->arrayNode('translation')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Payment\Entity\PaymentMethodMentionTranslation')->end()
                            ->scalarNode('repository')->end()
                            ->arrayNode('fields')
                                ->prototype('scalar')->end()
    ...
    /**
     * Adds `shipment resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addShipmentResourcesSection(NodeBuilder $node)
    {
        $node
     ...
     * @param NodeBuilder $node
     */
    private function addSupplierResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('supplier')
                ->addDefaultsIfNotSet()
    ...
    /**
     * Adds `quote resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addQuoteResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('quote')
                ->addDefaultsIfNotSet()
    ...
    /**
     * Adds `pricing resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addPricingResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('tax')
                ->addDefaultsIfNotSet()
            ...
            ->arrayNode('tax_rule')
                ...
                ->end()
            ->end()
            ->arrayNode('tax_rule_mention')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Pricing\Entity\TaxRuleMention')->end()
                    ->scalarNode('repository')->end()
                    ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Pricing\TaxRuleMentionType')->end()
                    ->scalarNode('parent')->defaultValue('ekyna_commerce.tax_rule')->end()
                    ->arrayNode('translation')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('entity')->defaultValue('Ekyna\Component\Commerce\Pricing\Entity\TaxRuleMentionTranslation')->end()
                            ->scalarNode('repository')->end()
                            ->arrayNode('fields')
                                ->prototype('scalar')->end()
                                ->defaultValue(['content'])
    ...
    /**
     * Adds `support resources` section.
     *
     * @param NodeBuilder $node
     */
    private function addSupportResourcesSection(NodeBuilder $node)
    {
        $node
            ->arrayNode('ticket')
                ->addDefaultsIfNotSet()
