                    ...
                    ->children()
                        ...
                        ->arrayNode('cart')
                            ...
                            ->children()
                                ...
                                ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Sale\CartType')->end()
                        ...
                        ->arrayNode('order')
                            ...
                            ->children()
                                ...
                                ->scalarNode('operator')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Sale\OrderType')->end()
                        ...
                        ->arrayNode('quote')
                            ...
                            ->children()
                                ...
                                ->scalarNode('operator')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->defaultValue('Ekyna\Bundle\CommerceBundle\Form\Type\Sale\QuoteType')->end()
