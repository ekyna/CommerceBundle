...
namespace Ekyna\Bundle\CommerceBundle\Controller\Account\Order\Shipment;
 ...
 * @package Ekyna\Bundle\CommerceBundle\Controller\Account\Order\Shipment
...
class DownloadController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $shipment = $this->resourceHelper->findShipmentByOrderAndId($order, $request->attributes->getInt('id'));

        $renderer = $this
            ->rendererFactory
            ->createRenderer($shipment, DocumentTypes::TYPE_SHIPMENT_BILL);
